defmodule Platform.ProductsTest do
  ...
  describe "gameplays" do
    ...
    @valid_attrs %{game_id: 42, player_id: 42, player_score: 42}
    @update_attrs %{game_id: 42, player_id: 42, player_score: 42}
    @invalid_attrs %{game_id: nil, player_id: nil, player_score: nil}
